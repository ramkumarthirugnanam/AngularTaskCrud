...
export class AppComponent implements OnInit {
  ...
  startEdit(i: number, id: number, name: string, description: string, priority: string,  assigned_date: Date, closing_date: Date, suggested_solution: string,) {
    this.id = id;
    // index row is used just for debugging proposes and can be removed
    this.index = i;
    console.log(this.index);
    const dialogRef = this.dialog.open(EditDialogComponent, {
      data: {id: id, name: name, description: description, priority: priority, assigned_date: assigned_date, closing_date: closing_date, suggested_solution: suggested_solution}
    });
